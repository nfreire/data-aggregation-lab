...
nohup java -Djsse.enableSNIExtension=false -Dsun.net.inetaddr.ttl=0 -Xmx4G -cp casestudy:classes:$CLASSPATH inescid.dataaggregation.casestudies.schemaorgcrawling.ScriptRunFullCrawlForAnalisys data/schemaorgcrawling data/HttpRepository 1000 false true 10 "/home/nfreire/.credentials/Data Aggregation Lab-b1ec5c3705fc.json" >output-ScriptRunFullCrawlSchemaorg.txt 2>&1 &
