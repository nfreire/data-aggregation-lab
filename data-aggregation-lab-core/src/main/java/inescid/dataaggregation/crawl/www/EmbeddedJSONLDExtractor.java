...
public class EmbeddedJSONLDExtractor implements Extractor.TagSoupDOMExtractor {
	...
	public void run(ExtractionParameters extractionParameters,
		...
		System.out.println(documentIRI.stringValue());
		out.printReport(System.out);
	 ...
	 *
	 */
	public static class EmbeddedJSONLDExtractorFactory extends SimpleExtractorFactory<EmbeddedJSONLDExtractor> implements
