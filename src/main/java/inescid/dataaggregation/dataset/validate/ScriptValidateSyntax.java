package inescid.dataaggregation.dataset.validate;
...
public class ScriptValidateSyntax {
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(ScriptValidateSyntax.class);
	...
	public static void main(String[] args) {
		try {
			...
			Dataset dataset=Global.getDatasetRegistryRepository().getDatasetByUri("http://192.92.149.69:8983/data-aggregation-lab/static/data-external/europeana-dataset-sitemap/sitemap.xml");
